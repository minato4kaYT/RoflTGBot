...
async def cmd_help(message: types.Message) -> None:
    ...
    await message.answer(
        "Что я умею:\n"
        "• /rofl — присылаю случайный рофл\n"
        "• /mock [текст] — превращаю текст в спонжбоб-насмешку\n"
        "• /coin — подбрасываю монетку\n"
        "• Просто напиши текст — я отвечу эхо с подколом",
        reply_markup=MAIN_KEYBOARD,
    )

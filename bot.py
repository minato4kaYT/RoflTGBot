...
async def cmd_start(message: types.Message) -> None:
    ...
    start_text = (
        ...
        "ℹ️ Что вы получаете:\n ⚠️ Надёжная защита от мошенников. Если вам отправят вредоносного бота — мы сразу вас предупредим. Защита работает в реальном времени и блокирует популярные схемы, включая кражу подарков.\n 💨 Мгновенные уведомления. Кто-то удалил или отредактировал сообщение? Вы узнаете сразу — уведомление придет прямо в личку.\n 🔍 Эксклюзивные функции. Уникальные инструменты и возможности. Мы не просто сохраняем сообщения — мы уровень выше."
    )
